      ...
      <div className="flex justify-center p-2 sm:p-10  ">
        <div className="max-w-5xl w-full  flex  p-4 bg-white rounded-xl flex-col">
          ...
          <p className="text-sm text-justify p-2 text-zinc-400 leading-6">
            ...
            Lanka, majoring in Computing and Information Systems. Currently, I'm
            deeply immersed in Flutter development for mobile applications and
            full-stack web development.I'm passionate about leveraging
            technology to solve real-world problems and enhance user
            interactions. As I continue to expand my skills and knowledge, I'm
            excited about exploring new technologies and methodologies that
            drive innovation. Feel free to reach out to me through the contact
